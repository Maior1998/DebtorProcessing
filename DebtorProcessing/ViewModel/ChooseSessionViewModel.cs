...
namespace DebtorProcessing.ViewModel
{
    public class ChooseSessionViewModel : ReactiveObject
    {
        ...
        public ChooseSessionViewModel(SessionService session, PageService pageService)
        {
            ...
            this.Sessions.ToObservableChangeSet().WhenAnyPropertyChanged(nameof(SelectSessionItem.IsChecked)).Subscribe(_ => OnSelectionChanged());
        ...
        public AsyncCommand ChooseSession => chooseSession ??= new(async () =>
        {
            ...
            await App.Current.Dispatcher.InvokeAsync(() => pageService.NavigateWithoutHistoryCommand.Execute(new TabsView()));
        });
